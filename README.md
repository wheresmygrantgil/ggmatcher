...
Researchers can type their name into a search box and view grants that are relevant to them. The matching data is stored in the `data/` directory (`grants.json`, `matches.json`, etc.).
